...
public class DispatcherFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            //filter xử lý các trang được phép vào khi chưa đăng nhập
            ...
            String url = "";
            if (us == null && action != null) {//chưa đăng nhập và có hành động
                switch (action) {
                    case IMyConstant.ACTION_PAGE_WELCOME: {
                        url = IMyConstant.PAGE_WELCOME;
                        break;
                    }
                    //trang service
