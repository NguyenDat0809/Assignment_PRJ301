 ...
 * @author uinic
 */
public class AdStaffCreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                BigDecimal stid = new BigDecimal(staffDAO.getMaxStaffId() + 1);
                ...
                if (staff != null) {
                    if (staffDAO.createStaff(staff)) {
                        request.setAttribute("createstaffresult", "Create Staff Success");
                    } else {
                        request.setAttribute("createstaffresult", "Create Staff Fail");
                    }
                }
            } catch (Exception e) {
