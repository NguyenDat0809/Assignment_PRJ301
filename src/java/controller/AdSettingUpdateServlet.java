 ...
 * @author uinic
 */
public class AdSettingUpdateServlet extends HttpServlet {
            ...
            try {
                ...
                if (staff != null) {
                    ...
                    if (staffDAO.updateStaff(staff)) {
                        request.setAttribute("updatestaffresult", "Edit Staff Success !");
                        session.setAttribute("staff", staff);
                    } else {
                        request.setAttribute("updatestaffresult", "Edit Staff Fail !");
                    }
                }
            } catch (Exception e) {
                request.getRequestDispatcher("error.html").forward(request, response);
            } finally {
                request.getRequestDispatcher("ad_page_setting.jsp").forward(request, response);
            }
        }
    }
